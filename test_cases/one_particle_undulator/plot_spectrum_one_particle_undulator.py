...
# Other parameters used were E_slice_eV = 0.01, t_slice_s = 1e-18.
fig, ax = plt.subplots()
...
print('Expected fundamental frequency according to formula 2*gamma^2*omega_beta/(1+K^2/2), where K = 1.33*10^-10*r_beta*(gamma*n_e)^0.5 is ' + str(int(round(omega_1*hbar/e)))+ ' eV.')
