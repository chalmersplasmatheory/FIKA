...
# Also, E_radMax_eV = 2000, E_slice_eV = 10 and t_slice_s = 1e-16 were chosen.
...
folder = 'test_cases/PIC_trajectories/without_macroparticle_weights/'
...
folder_w = 'test_cases/PIC_trajectories/with_macroparticle_weights/'
